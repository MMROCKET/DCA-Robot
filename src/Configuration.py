...
# bot_config = BotConfiguration('test.ini')
# get_info = bot_config.load()
# print('binance_secret_key = {}, binance_api_key = {}'.format(get_info.binance_secret_key, get_info.binance_api_key))
# url= URLConfiguration('test.ini')
# geturl = url.load_url()
# print('Testnet_url = {}, get_price = {}'.format(geturl.Testnet_url, geturl.get_price))
# bot_config = BotConfiguration('test.ini')
# get_info = bot_config.load()
# print('binance_secret_key = {}, binance_api_key = {}'.format(get_info.binance_secret_key, get_info.binance_api_key))
